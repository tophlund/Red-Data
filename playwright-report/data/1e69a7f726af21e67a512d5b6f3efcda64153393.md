...
- Name: Basic Application Functionality >> should meet basic accessibility requirements
- Location: C:\Red Data\e2e\basic.spec.ts:75:3

# Error details

```
Error: expect.toBeVisible: Error: strict mode violation: locator('main, [role="main"]') resolved to 2 elements:
    1) <main id="main" class="flex-1">…</main> aka locator('#main')
    2) <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">…</main> aka locator('#main').getByRole('main')

Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('main, [role="main"]')

    at C:\Red Data\e2e\basic.spec.ts:80:24
```
