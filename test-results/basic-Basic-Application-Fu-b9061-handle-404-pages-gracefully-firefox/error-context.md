...
- Name: Basic Application Functionality >> should handle 404 pages gracefully
- Location: C:\Red Data\e2e\basic.spec.ts:55:3

# Error details

```
Error: expect.toBeVisible: Error: strict mode violation: locator('body') resolved to 2 elements:
    1) <body class="min-h-screen bg-gray-50 font-sans antialiased">…</body> aka getByText('Skip to main contentRed Data')
    2) <body class="min-h-screen bg-gray-50 font-sans antialiased">…</body> aka getByText('Skip to main content404Not')

Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('body')

    at C:\Red Data\e2e\basic.spec.ts:62:40
```
